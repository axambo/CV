...
\years{2017}peterMann. (January 8, 2017). Live coding session. \emph{Noiselets}. Freedonia, Barcelona.\\
...
\years{2013}Xambó, A. (October 4, 2013). Live coding session. \emph{Perspectives on Multichannel Live Coding}. PHONOS. Sala Polivalent, UPF. Barcelona.\\
...
\subsection*{Group Performances}
\years{2012}pulso. (March 15, 2012). Live coding session. \emph{Live Coding Sessions}. Niu. Barcelona.\\
...
Collaborator: Gerard Roma.\\[1.5cm] %WORKAROUND WITH CURRENT CONTENT. DELETE WITH ADDITION OF NEW CONTENT.
