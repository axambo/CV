...
\years{04/2000--05/2001}\textsc{Web Designer \&  Motion Graphic Designer}. MediaPark | ParkNet, Barcelona. \\[1.2cm]
...
Candidate’s Share: 50\% (\$1,650)\\ [0.2cm] 
...
\years{2012} \textbf{Xambó, A.}; Roma, G. and Bovermann, T. (April 15, 2012). “Tangible Musical Interfaces with SuperCollider". \emph{SuperCollider Symposium 2012}, Goldsmiths, University of London. London.\\[0.1cm]%hack
...
\years{2018a}Anna Xambó's “H2RI.01-04". (June 21, 2018). Rare Frequency on WZBC 90.3 FM Newton Boston College Radio.\\
...
\years{2010a}peterMann's “init 2". (April 12, 2010). Sismógrafo.\\[2.1cm]%hack
...
%\years{Forthcoming}\textsc{MareNostrum}. CubeFest. Virginia Tech, Blacksburg, Virginia, USA.\\
...
\years{2012}“Live Coding Sessions". (March 15, 2012). Niu. Barcelona.\\[0.1cm]
...
\years{2018}\emph{Transactions on Computing Education}. ACM.\\
...
Catalan (native or bilingual proficiency), Spanish (native or bilingual proficiency), English (full professional proficiency), German (basic level), Italian (basic level), French (basic level).\\[-0.5cm]%hack to avoid widow line, remove if not needed
