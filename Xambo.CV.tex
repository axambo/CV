...
\years{2019}\textbf{Xambó, A.}, Saue, S., Jensenius, A.R., Støckert, R., Brandtsegg, Ø. (in press). "NIME Prototyping in Teams: A Participatory Approach to Teaching Physical Computing". In Proceedings of the New Interfaces for Musical Expression (NIME ’19). Porto Alegre, Brazil.\\
...
\years{2019} \textsc{Oral Presenter} (July 5, 2019). "NIME Prototyping in Teams: A Participatory Approach to Teaching Physical Computing". \emph{NIME '19}. Centro cultural, Universidade Federal do Rio Grande do Sol, Porto Alegre (UFRGS), Brazil.\\
...
\years{11/2018--present}Appraisal Committee Member for Hilmar Thordarson, Norwegian Programme for Artistic PhD Research, Norwegian Science and Technology University, Trondheim, Norway.\\
...
Catalan (native or bilingual proficiency), Spanish (native or bilingual proficiency), English (full professional proficiency), Norwegian (basic level), German (basic level), Italian (basic level), French (basic level).
