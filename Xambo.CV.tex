...
\years{2021d}\textbf{Xambó, A.} (Forthcoming). ``Live Coding with Crowdsourced Sounds and A Virtual Agent Companion''. \emph{WAC 21}. Online event. Barcelona, Spain.\\
\years{2021c}\textbf{Xambó, A.} (Forthcoming). ``A Live Coding Session With the Cloud and a Virtual Agent''. \emph{NIME 21}. Online event. Shanghai, China.\\
