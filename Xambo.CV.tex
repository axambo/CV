...
Practices of Music; New Technologies, Instruments and Agents}. Oodi, Helsinki, Finland.\\ 
...
\years{2022e}\textbf{Xambó, A.} (November 27, 2022). A live coding session using MIRLCa at ``Peforming Critical AI I: feedback, noise, corpus, code''. MusAI conference, Cafe OTO, London, UK.\\
...
Music \& Audio Apps: DAWs (Ableton, Cubase, Live, Logic Pro, Reaper), Max/MSP, PureData, SuperCollider, wave editors (Audacity, SoundForge, WaveEditor), audio analysis (Audition, Sonic Visualiser), audio measurement \& test (Lindos).\\
